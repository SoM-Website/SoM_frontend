...
export default function HomePage() {
  return (
    <>
      <section
        className="relative h-[46vh] min-h-[340px] w-full overflow-hidden border-b">
        {/* background Image */}
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container max-w-6xl mx-auto px-4">
            <div className="flex items-center gap-4 text-white">
              ...
              {/* 원형 로고 */}
            <div className="flex h-18 w-18 sm:h-22 sm:w-22 items-center justify-center rounded-full overflow-hidden bg-white">
              <img
                src="/home/logo.png"
                alt="SoM"
       ...
       <div className="mt-3 border-b border-[#735751]/40" /> 
        ...
        <div className="mt-6 grid gap-8 md:grid-cols-3">
          {[
            {
              name: "place1",
              img: "/home/place1.jpeg", 
            },
            {
              name: "place2",
              img: "/home/place2.jpeg",
            },
            {
              name: "place3",
              img: "/home/place3.jpeg",
            },
          ].map((p) => (
            <article key ={p.name}>
              {/* 이미지 */}
        ...
        <div className="grid gap-6 md:grid-cols-12 pt-6">
          <div className="md:col-start-1 md:col-span-12">
              <div className="text-2xl font-bold text-neutral-800">솜상담연구소의 상담실과 교육실입니다.</div>
            </div>
          <div className="md:col-start-1 md:col-span-20">
              <div className="prose prose-sm sm:prose-base max-w-none">
                <p className="whitespace-pre-line">
          ...
          {[
            {
              ...
              lines: [
                "우울, 불안, 대인관계, 성격, 스트레스 증상 을 호소하는 성인대상 (50분)"
              ],
            },
            {
              name: "부부 & 커플상담",
              ...
              lines: [
                "부부상담이라도 개인이 혼자 상담을 받으실 수 있습니다. (90분)",
              ],
            },
          ].map((p) => (
            <article key={p.name}>
...
<section className="w-full md:w-[60%] mx-auto px-4 pb-16">
  ...
  <div className="mt-6 grid gap-8 md:grid-cols-12 items-start">
    ...
    {/* 텍스트 */}
    <div className="md:col-span-6">
      <h4 className="mt-3 text-2xl font-bold text-neutral-800">SoM 스트레스 관리 프로그램</h4>
