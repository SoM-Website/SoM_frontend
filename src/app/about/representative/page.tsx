...
export default function LeaderPage() {
  return (
    <>
      <PageHeader title="대표 소개" variant="split" />
        ...
        <Container>
          <section>
            <div className="flex flex-col md:flex-row items-stretch gap-8">
              {/* 정사각 이미지 */}
              <figure className="relative aspect-square w-[220px] md:w-[280px] lg:w-[320px] overflow-hidden bg-neutral-100 shrink-0">
                <Image
              ...
              {/* 텍스트 박스: 테두리 제거, 높이 매칭 */}
              <div className="flex-1 rounded-2xl p-5 md:p-6 min-h-[220px] md:min-h-[280px] lg:min-h-[320px] flex">
...
전 호원대학교, 성신여대, 덕성여대평교원 외래교수`}
        ...
        {/* 하단: 가로 전체 배경색 섹션 */}
        <section className="mt-10 bg-[#000000]/3 py-10">
          <Container>
